...
PeriodCounter2 = i - beta;

if beta == 72576
    
    Sharpe(1:ArtificialIndex1,1) = A_PERFORMANCE_TRADES_RET(1:ArtificialIndex1,1);
    SHARPE_AVERAGE = mean(A_PERFORMANCE_TRADES_RET(1:288,1));
    SHARPE_STDEV = std(A_PERFORMANCE_TRADES_RET(1:288,1));
    SHARPE = (SHARPE_AVERAGE/SHARPE_STDEV)*(sqrt(252));
